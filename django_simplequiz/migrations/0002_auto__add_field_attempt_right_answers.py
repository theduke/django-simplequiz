...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attempt.right_answers'
        db.add_column(u'django_simplequiz_attempt', 'right_answers',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attempt.right_answers'
        db.delete_column(u'django_simplequiz_attempt', 'right_answers')
