...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'django_simplequiz_quiz', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_simplequiz.Category'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'django_simplequiz_quiz', 'category_id')
