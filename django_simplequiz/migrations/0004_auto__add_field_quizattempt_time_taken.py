...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizAttempt.time_taken'
        db.add_column(u'django_simplequiz_quizattempt', 'time_taken',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuizAttempt.time_taken'
        db.delete_column(u'django_simplequiz_quizattempt', 'time_taken')
