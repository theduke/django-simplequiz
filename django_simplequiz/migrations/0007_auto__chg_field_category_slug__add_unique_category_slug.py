...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'django_simplequiz_category', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50))
        # Adding unique constraint on 'Category', fields ['slug']
        db.create_unique(u'django_simplequiz_category', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['slug']
        db.delete_unique(u'django_simplequiz_category', ['slug'])


        # Changing field 'Category.slug'
        db.alter_column(u'django_simplequiz_category', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
