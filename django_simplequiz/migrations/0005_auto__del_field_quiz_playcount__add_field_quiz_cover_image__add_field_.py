...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Quiz.playcount'
        db.delete_column(u'django_simplequiz_quiz', 'playcount')

        # Adding field 'Quiz.cover_image'
        db.add_column(u'django_simplequiz_quiz', 'cover_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Quiz.verified'
        db.add_column(u'django_simplequiz_quiz', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Quiz.featured'
        db.add_column(u'django_simplequiz_quiz', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Quiz.playcount'
        db.add_column(u'django_simplequiz_quiz', 'playcount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Quiz.cover_image'
        db.delete_column(u'django_simplequiz_quiz', 'cover_image')

        # Deleting field 'Quiz.verified'
        db.delete_column(u'django_simplequiz_quiz', 'verified')

        # Deleting field 'Quiz.featured'
        db.delete_column(u'django_simplequiz_quiz', 'featured')
    ...
    models = {
        ...
        u'django_simplequiz.quiz': {
            ...
            'cover_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '255', 'blank': 'True'}),
