...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quiz.move_answered_to_bottom'
        db.add_column(u'django_simplequiz_quiz', 'move_answered_to_bottom',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Quiz.move_active_to_top'
        db.add_column(u'django_simplequiz_quiz', 'move_active_to_top',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quiz.move_answered_to_bottom'
        db.delete_column(u'django_simplequiz_quiz', 'move_answered_to_bottom')

        # Deleting field 'Quiz.move_active_to_top'
        db.delete_column(u'django_simplequiz_quiz', 'move_active_to_top')
