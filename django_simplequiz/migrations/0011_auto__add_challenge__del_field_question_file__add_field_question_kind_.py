...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Question.file'
        db.delete_column(u'django_simplequiz_question', 'file')

        # Adding field 'Question.kind'
        db.add_column(u'django_simplequiz_question', 'kind',
                      self.gf('django.db.models.fields.CharField')(default='plain', max_length=50),
                      keep_default=False)

        # Adding field 'Question.image'
        db.add_column(u'django_simplequiz_question', 'image',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Question.file'
        raise RuntimeError("Cannot reverse this migration. 'Question.file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Question.file'
        db.add_column(u'django_simplequiz_question', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Question.kind'
        db.delete_column(u'django_simplequiz_question', 'kind')

        # Deleting field 'Question.image'
        db.delete_column(u'django_simplequiz_question', 'image')
