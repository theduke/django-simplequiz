...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attempt.mistakes'
        db.add_column(u'django_simplequiz_attempt', 'mistakes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attempt.mistakes'
        db.delete_column(u'django_simplequiz_attempt', 'mistakes')
