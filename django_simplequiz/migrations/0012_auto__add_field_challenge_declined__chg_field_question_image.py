...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.declined'
        db.add_column(u'django_simplequiz_challenge', 'declined',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Question.image'
        db.alter_column(u'django_simplequiz_question', 'image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=255))

    def backwards(self, orm):
        # Deleting field 'Challenge.declined'
        db.delete_column(u'django_simplequiz_challenge', 'declined')


        # Changing field 'Question.image'
        db.alter_column(u'django_simplequiz_question', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))
