...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quiz.ignore_case'
        db.add_column(u'django_simplequiz_quiz', 'ignore_case',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quiz.ignore_case'
        db.delete_column(u'django_simplequiz_quiz', 'ignore_case')
