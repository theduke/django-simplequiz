...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Quiz.end_on_wrong_answer'
        db.delete_column(u'django_simplequiz_quiz', 'end_on_wrong_answer')

        # Adding field 'Quiz.end_on_wrong_answers'
        db.add_column(u'django_simplequiz_quiz', 'end_on_wrong_answers',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Quiz.end_on_wrong_answer'
        db.add_column(u'django_simplequiz_quiz', 'end_on_wrong_answer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Quiz.end_on_wrong_answers'
        db.delete_column(u'django_simplequiz_quiz', 'end_on_wrong_answers')
