...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Quiz', fields ['title']
        db.create_unique(u'django_simplequiz_quiz', ['title'])

        # Adding unique constraint on 'Quiz', fields ['slug']
        db.create_unique(u'django_simplequiz_quiz', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Quiz', fields ['slug']
        db.delete_unique(u'django_simplequiz_quiz', ['slug'])

        # Removing unique constraint on 'Quiz', fields ['title']
        db.delete_unique(u'django_simplequiz_quiz', ['title'])
