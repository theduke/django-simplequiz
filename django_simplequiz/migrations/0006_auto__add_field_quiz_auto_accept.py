...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quiz.auto_accept'
        db.add_column(u'django_simplequiz_quiz', 'auto_accept',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quiz.auto_accept'
        db.delete_column(u'django_simplequiz_quiz', 'auto_accept')
