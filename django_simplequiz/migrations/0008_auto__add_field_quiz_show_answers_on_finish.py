...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quiz.show_answers_on_finish'
        db.add_column(u'django_simplequiz_quiz', 'show_answers_on_finish',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quiz.show_answers_on_finish'
        db.delete_column(u'django_simplequiz_quiz', 'show_answers_on_finish')
